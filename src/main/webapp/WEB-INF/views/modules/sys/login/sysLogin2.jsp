	...
	<form id="loginForm" class="form-signin" action="${ctx}/login" method="post">
		...
		<div id="themeSwitch" class="dropdown">
			...
			<ul class="dropdown-menu">
			  <c:forEach items="${fns:getDictItemListL('001','theme','zh_CN')}" var="dict"><li><a href="#" onclick="location='${pageContext.request.contextPath}/theme/${dict.value}?url='+location.href">${dict.label}</a></li></c:forEach>
			</ul>
