...
$(document).ready(function() {
	if("${claimId}" != null && $.trim("${claimId}").length > 0){
		 $.ajax({
	        ...
	        url: "${ctx}/sysfile/sysfileupload/getFileList",
	        dataType: "json",
	        success: function(data){
				spliceHtml(data);
	        },
	...
	<form action="${ctx}/sysfile/sysfileupload/fileToUpload" target="hidden_frame" method="post" id="clientForm" enctype="multipart/form-data">
