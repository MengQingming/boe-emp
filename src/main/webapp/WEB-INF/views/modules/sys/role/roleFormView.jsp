...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$('.select2-container').width($('#roleName').width() + 12 + 'px');
		});
...
<body>
	...
	<form:form id="inputForm" modelAttribute="role" action="${ctx}/sys/role/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<c:if test="${!role.currentUser.admin}">
				<sys:treeselect id="group" name="group.id" cssStyle="width:210px;" value="${role.group.id}" labelName="group.groupName" labelValue="${role.group.groupName}" 
				title="机构" url="/sys/group/treeData1?companyId=${role.currentUser.company.id}" cssClass="input-small" allowClear="true"/>
			</c:if>
			</div>
		</div>
		<div class="control-group">
			...
			<div class="controls">
				...
				<form:input path="roleName" htmlEscape="false" maxlength="50" class="required" disabled="true"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="roleNo" htmlEscape="false" maxlength="50" class="required" disabled="true"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="displayOrder" htmlEscape="false" maxlength="50" class="required" disabled="true"/>
			</div>
		</div>
		<div class="control-group">
