...
jQuery.validator.addMethod("checkMoney", function(value, element) {
	   var fax = /^(([1-9][0-9]*)|(([0]\.\d{1,2}|[1-9][0-9]*\.\d{1,2})))$/;
	   if(value == 0){
		   return true;
	   }
	   return this.optional(element) || (fax.test(value));
