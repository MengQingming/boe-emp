package com.boe.gen.service;

import java.util.List;
import java.util.Map;

import com.boe.gen.dao.GenTableColumnDao;
...
import com.boe.gen.dao.GenSchemeDao;
import com.boe.gen.dao.GenTableDao;
...
import com.boe.gen.util.GenUtils;
...
//	private GenTemplateDao genTemplateDao;
	...
	public String save(GenScheme genScheme) {
		if (null==genScheme.getId() || genScheme.getId()<0){
			genScheme.preInsert();
