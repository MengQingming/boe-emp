...
public abstract class BaseController {
	protected SimpleDateFormat formaterDate = new SimpleDateFormat("yyyy-MM-dd");
	protected SimpleDateFormat formaterDateTime = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
...
//			}
	...
	public String getLanguage(){
		String language = UserUtils.getUser().getLang();
