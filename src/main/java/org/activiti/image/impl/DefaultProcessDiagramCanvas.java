...
public class DefaultProcessDiagramCanvas {
	...
	protected static Color CURRENT_HIGHLIGHT_COLOR = Color.GREEN;
	...
	protected String activityFontName = "SimSun";    //原始值为 Arial
	protected String labelFontName = "SimSun";
	protected String annotationFontName = "SimSun";
